...
const createGalleryItem = (photo, index) => {
  return `
        <li class="gallery__item">
            <a href="${photo.original}" class="gallery__link">
                <img src="${photo.preview}" alt="${photo.description}" class="gallery__image" data-source="${photo.original}" data-index="${index}">
            </a>
        </li>
    `;

};
const itemGallery = galleryItems.map(createGalleryItem).join('')
searchGallery.insertAdjacentHTML('beforeend', itemGallery)
