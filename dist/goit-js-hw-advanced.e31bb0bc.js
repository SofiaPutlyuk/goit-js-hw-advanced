...
var keys = ['a', 'b', 'c', 'd', 'e', 'Enter', 'ArrowUp', 'ArrowDown', 'ArrowLeft', 'ArrowRight'];
var currentKeyIndex = 0;
var key = '';
function randomKey() {
  if (currentKeyIndex < keys.length) {
    key = keys[currentKeyIndex];
    var searchKeyId = document.getElementById('key');
    searchKeyId.innerHTML = "".concat(key);
    console.log(key);
  } else {
    var mySuccess = (0, _PNotify.success)({
...
var searchGameButton = document.getElementById("newGame");
searchGameButton.addEventListener('click', function () {
  currentKeyIndex = 0;
  randomKey();
  var mySuccess = (0, _PNotify.notice)({
    text: "Гру розпочато! Натисніть клавішу."
  });
});
randomKey();
/*Task 2 */
var searchDiagram = document.getElementById('sales-chart');
var chartData = {
...
var salesChart = new Chart(searchDiagram, config);
},{"@pnotify/core/dist/PNotify.js":"node_modules/@pnotify/core/dist/PNotify.js","@pnotify/mobile/dist/PNotifyMobile.js":"node_modules/@pnotify/mobile/dist/PNotifyMobile.js","@pnotify/core/dist/BrightTheme.css":"node_modules/@pnotify/core/dist/BrightTheme.css"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "7696" + '/');
...
//# sourceMappingURL=/goit-js-hw-advanced.e31bb0bc.js.map